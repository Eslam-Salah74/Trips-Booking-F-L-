                ...
                @foreach ($services as $item )
                    <div class="icon-box-item text-center col-lg-4 col-md-6 mb-4">
                        <div class="rounded shadow py-5 px-4">
                            ...
                            <p class="mb-4">{{$item->short_desc}}</p> <a class="btn btn-sm btn-outline-primary" href="{{route('servicedetails',$item->id)}}" wire:navigate>View Details <i class="las la-arrow-right ms-1"></i></a>
                        </div>
                    </div>
                    @php
                        $x++;
