                                ...
                                <div class="contact-form">
                                  ...
                                  <form wire:submit.prevent='submit'>
                                      ...
                                      <div class="form-group mb-4 pb-2">
                                          ...
                                          <textarea class="form-control shadow-none @error('message') is-invalid @enderror" id="message" rows="3" wire:model='message'></textarea>
                                          @error('message')
                                              <p class="invalid-feedback">{{ $message }}</p>
                                          @enderror
                                      </div>
                                      <button class="btn btn-primary w-100" type="submit" wire:navicate>Send Message</button>
                                  </form>
                              </div>
