    ...
    <div class="container">
        <div class="row align-items-center justify-content-center">
            ...
            <div class="block text-center text-lg-start pe-0 pe-xl-5">
                <h1 class="text-capitalize mb-4">El magd for. Religious. Tourism!</h1>
                <p class="mb-4">Your gateway to Arafat</p> <a type="button"
                class="btn btn-primary" href="{{route('trips')}}" data-bs-toggle="modal" data-bs-target="#applyLoan" wire:navigate>Book Now<span style="font-size: 14px;" class="ms-2 fas fa-arrow-right"></span></a>
            </div>
            </div>
            <div class="col-lg-6">
        ...
        <div class="container">
            <div class="row">
                <div class="section-title pt-4">
                    ...
                    <h1 class="text-uppercase fw-bold mb-3">Our Trips</h1>
        ...
        @if($services->isNotEmpty())
            ...
            @foreach ($services as $item)
                <div class="col-lg-4 col-md-6 service-item">
                    <a class="text-black" href="{{route('servicedetails',$item->id)}}" wire:navigate>
                        <div class="block">
                            <span class="colored-box text-center h3 mb-4">{{$x}}</span>
                            <h3 class="mb-3 service-title">{{ $item->title }}</h3>
                            <p class="mb-0 service-description">{{ $item->short_desc }}</p>
                        </div>
                    </a>
                    </a>
                </div>
