          ...
          <div class="container">
              <div class="row">
                  <div class="col-8 mx-auto text-center">
                      <h2 class="mb-3 text-capitalize">Booking</h2>
        ...
        <div class="container">
          <div class="row">
                <div class="col-lg-7">
                            ...
                            <div class="col-lg-12">
                                <div class="contact-form">
                                  ...
                                  <form wire:submit.prevent='submit'>
                                    @csrf
                                    <div class="col-lg-12">
                                        <p class="text-primary text-uppercase fw-bold mb-3">let&rsquo;s get booking</p>
                                        <div class="form-group mb-4 pb-2">
                                            <label for="name" class="form-label">Name</label>
                                            <input type="text" class="form-control shadow-none @error('name') is-invalid @enderror" id="name" wire:model='name'>
                                            @error('name')
                                        ...
                                        <div class="form-group mb-4 pb-2">
                                            ...
                                            <input type="email" class="form-control shadow-none @error('email') is-invalid @enderror" id="email" wire:model='email'>
                                            @error('email')
                                                <p class="invalid-feedback">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        <div class="form-group mb-4 pb-2">
                                            ...
                                            <input type="number" class="form-control shadow-none @error('phone1') is-invalid @enderror" id="phone1" wire:model='phone1'>
                                            @error('phone1')
                                                <p class="invalid-feedback">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        <div class="form-group mb-4 pb-2">
                                            ...
                                            <input type="number" class="form-control shadow-none @error('phone2') is-invalid @enderror" id="phone2" wire:model='phone2'>
                                            @error('phone2')
                                                <p class="invalid-feedback">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        <div class="form-group mb-4 pb-2">
                                            ...
                                            <input type="text" class="form-control shadow-none @error('address') is-invalid @enderror" id="address" wire:model='address'>
                                            @error('address')
                                                <p class="invalid-feedback">{{ $message }}</p>
                                            @enderror
                                        </div>
                  ...
                  <div class="shadow rounded p-5 bg-white col-lg-5">
                    <div class="col-12 mb-4">
                      <h1>Booingk Summary</h1>
                    </div>
                    <br><br>
                          ...
                          <li class="d-flex widget-post align-items-center">
                            <div class="widget-post-image flex-shrink-0 me-3">
                                <img class="rounded" loading="lazy" decoding="async" 
                                  src="{{ asset('storage/' . $trip->featured_img) }}" 
                                  alt="{{ $trip->tripname }}">
                            </div>
                          <li>
                        </ul>
                      </div>
                      <p class="text-primary text-uppercase fw-bold mb-3"> Trip Name: </p> {{$trip->tripname}}
                          <p class="text-primary text-uppercase fw-bold">Trip Price: </p> {{$trip->price}}
                          <p class="text-primary text-uppercase fw-bold"> Trip Location: </p> {{$trip->city->name}}
                          <p class="text-primary text-uppercase fw-bold"> Trip Subdiscription: </p> {{$trip->subdescription}}
                  </div>
              </div>
          </div>
      </section>
