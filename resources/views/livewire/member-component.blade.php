            ...
            <div class="row">
                <div class="col-8 mx-auto text-center">
                    ...
                    <ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
                        ...
                        <li class="list-inline-item">/ &nbsp; <a href="{{route('members')}}" wire:navigate>Our Team</a>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    @foreach ($members as $item)
                        <div class="col-xl-3 col-lg-4 col-md-6 mt-4">
                            <div class="card bg-transparent border-0 text-center">
                                <div class="card-img">
                                    <img loading="lazy" decoding="async" src="{{ asset('storage/' . $item->img) }}"  alt="{{ $item->name }}" class="rounded w-100" width="300" height="332">
                                    <ul class="card-social list-inline">
                                        @foreach ($item->socialmedia as $social)
                                            @if (is_array($social) && array_key_exists('key', $social) && array_key_exists('value', $social))
                                                <li class="list-inline-item">
                                                    <a href="{{ $social['value'] }}" target="_blank">
                                                        <i class="fab fa-{{ $social['key'] }}"></i>
                                                    </a>
                                                </li>
                                            @else
                                                <li class="list-inline-item">بيانات غير متاحة</li>
                                            @endif
                                        @endforeach
                                    </ul>
