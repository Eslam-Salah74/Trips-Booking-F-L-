                ...
                <div class="container">
                    <div class="row justify-content-center align-items-center">
                        ...
                        <div class="col-lg-4 mt-5 mt-lg-0">
                            <img loading="lazy" decoding="async" src="{{asset('storage/'.$about->img)}}" alt="Business Loans &lt;br&gt; For Daily Expenses" class="rounded w-100">
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    @foreach ($members as $members)
                        <div class="col-xl-3 col-lg-4 col-md-6 mt-4">
                            <div class="card bg-transparent border-0 text-center">
                                <div class="card-img">
                                    <img loading="lazy" decoding="async" src="{{asset('storage/'.$members->img)}}" alt="Scarlet Pena" class="rounded w-100" width="300" height="332">
